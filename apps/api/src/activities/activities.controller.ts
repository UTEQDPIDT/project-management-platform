...
import { ApiAcceptedResponse, ApiConsumes, ApiCreatedResponse, ApiNotFoundResponse, ApiTags, ApiUnauthorizedResponse } from '@nestjs/swagger';
...
export class ActivitiesController {
  ...
  create(@Body() createActivityDto: CreateActivityDto, @Req() req, @UploadedFiles() files: Express.Multer.File[]) {
